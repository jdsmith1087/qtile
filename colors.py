...
SolarizedDark = [
    ...
    ["#ffffff", "#ffffff"]  # color15
    ]

SolarizedLight = [
    ["#010406", "#010406"], # bg
    ["#657b83", "#657b83"], # fg
    ["#0d1d2b", "#0d1d2b"], # color01
    ["#193750", "#193750"], # color02
    ["#255075", "#255075"], # color03
    ["#316a9a", "#316a9a"], # color04
    ["#3d84bf", "#3d84bf"], # color05
    ["#619bcc", "#619bcc"], # color06
    ["#86b2d8", "#86b2d8"]  # color15
    ]
